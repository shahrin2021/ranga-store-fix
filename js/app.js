...
//   const detailsContainer= document.getElementById('detail-product')
//   detailsContainer.textContent="";
//   const div = document.createElement('div');
//   let style = ['col-6', 'offset-6'];
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${product.image}></img>
      ...
      <button onclick="showSingleProduct()" id="details-btn" class="btn btn-danger">Details</button></div>
